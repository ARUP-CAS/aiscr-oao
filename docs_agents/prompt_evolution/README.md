...
Tento adresář obsahuje návrhy na zlepšení `docs_agents/PROMPT.md`
...
4. Přijané návrhy se aplikují na `docs_agents/PROMPT.md` před zahájením nového audit cyklu.
5. Agent nesmí sám modifikovat `PROMPT.md`.
